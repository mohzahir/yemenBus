...
class LoginController extends Controller
{
    ...
    */
    ...
    public function passengerLogin(Request $request)
    {
        ...
        if (Auth::guard('passenger')->attempt(['phone' =>  $phone, 'password' => $request->password], 
        $request->get('remember'))||Auth::guard('passenger')->attempt(['y_phone' => $phoneProv,
    ...
    public function marketerLogin(Request $request)
    {
        ...
        if (Auth::guard('marketer')->attempt(['phone' =>  $phone, 'password' => $request->password],
         $request->get('remember'))||Auth::guard('marketer')->attempt(['y_phone' => $phoneProv, 'password' => $request->password], $request->get('remember'))) {
