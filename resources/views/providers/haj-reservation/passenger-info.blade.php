...
<div class="main_container col-md-12 col-md-8 col-sm-12 col-xs- " >
    ...
    <div class="d-flex justify-content-between" style="dispaly:inline;margin-bottom:50px;">
        <nav aria-label="breadcrumb" style="margin-top:-50px;">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item " aria-current="page"> <a href="{{route('provider.haj.reservations.index')}}">حجوزات الحج والعمرة</a></li>
    ...
    <div class="row">
        ...
        <form action="{{ route('provider.haj.reservations.storePassengerInfo', ['id' => $reservation->id]) }}" method="post">
            @csrf
            <div class="col-md-6">
            ...
            <div class="col-md-12 mt-3">
                ...
                <a href="{{ route('provider.haj.reservations.index') }}" class="btn btn-danger">رجوع</a>
            </div>
        </form>
