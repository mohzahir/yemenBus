...
<div class="container-fluid">
    ...
    <div class="row container_section">
        ...
        <!--Start left sidebar-->
        <div class="user_details close_user_details  bring_left"  style="height:300px;">
            <div class="user_area">
            

                <h1 class="h3"></h1>
                <p><a href="{{route('dashboard.provider.showAccountInfo')}}">بيانات المستخدم</a></p>

                <p><a href="{{route('dashboard.provider.updateAccountInfoForm')}}">اعدادت الحساب</a></p>
                ...
                <ul>
                   ...
                   <li><span class="glyphicon glyphicon-map-marker"></span><a href="{{route('dashboard.raiseOnMap.index')}}">اضافة مصعد على الخريطه</a></li>
                    ...
                    <li><span class="glyphicon glyphicon-edit"></span><a href="{{route('provider.reservations.confirmAll')}}">الحجوزات  </a></li>
                       ...
                       <li><span class="glyphicon glyphicon-edit"></span><a href="{{route('provider.trip.create')}}">اضافة رحلة </a></li>
                      <li><span class="glyphicon glyphicon-edit"></span><a href="{{route('provider.trip.index')}}">قائمة الرحلات</a></li>
                        
                   
                    
 <li><span class="glyphicon glyphicon-envelope"></span><a href="{{route('provider.sms')}}">ارسال رسالة للعميل</a></li>

                    <li><span class="glyphicon glyphicon-user"></span><a href="{{route('dashboard.provider.showAccountInfo')}}">بيانات الحساب </a>
                        <ul class="drop_main_menu">
                        <li><a href="{{route('dashboard.provider.showAccountInfo')}}">بيانات الشخصية</a></li>
                        <li><a href="{{route('dashboard.provider.updateAccountInfoForm')}}">اعدادات الحساب</a></li>
                            
                        </ul>
                    </li>
<li><span class="glyphicon glyphicon-envelope"></span><a href="{{route('logout.provider')}}" onclick="event.preventDefault();document.getElementById('logout-form').submit();"> تسجيل  الخروج </a></li>
 <form id="logout-form" action="{{ route('logout.provider') }}" method="POST" style="display: none;">
                                        @csrf
                                    </form>
                </ul>            </div>
        </div>
