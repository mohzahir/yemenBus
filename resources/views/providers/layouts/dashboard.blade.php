...
<div class="container-fluid">
        ...
        <div class="main_sidebar bring_right" style="width:250px;">
            <div class="main_sidebar_wrapper">
                ...
                <ul>
                    ...
                    <li><span class="glyphicon glyphicon-edit"></span><a href="{{route('marketer.reservations.confirmAll')}}">جوزات تم تاكيدها </a>
  ...
  <li><span class="glyphicon glyphicon-edit"></span><a href="{{route('dashboard.reservations.confirm')}}">تاكيد الحجوزات</a></li>
                    ...
                    <li><span class="glyphicon glyphicon-user"></span><a href="">بيانات الحساب </a>
                        <ul class="drop_main_menu">
                        <li><a href="{{route('dashboard.marketer.showAccountInfo')}}">بيانات الحساب</a></li>
                        <li><a href="{{route('dashboard.marketer.updateAccountInfoForm')}}">أعدادت الحساب</a></li>
                        </ul>
                    </li>
<li><span class="glyphicon glyphicon-envelope"></span><a href="{{route('logout.marketer')}}" onclick="event.preventDefault();document.getElementById('logout-form').submit();"> تسجيل  الخروج </a></li>
 <form id="logout-form" action="{{ route('logout.marketer') }}" method="POST" style="display: none;">
                                        @csrf
                                    </form>
                </ul>           
            </div>
        ...
        <div class="main_content_container" style="margin-top:24px;">
