...
<div class="main_container col-md-12 col-md-8 col-sm-12 col-xs- ">
  ...
  <div>
    ...
    <a href="{{route('provider.marketers.create')}}" class="btn btn-success btn-lg" style="float:left">اضافة مسوق</a>
  </div>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td style="display:inline-block;width:100%">
            <a class="btn btn-sm btn-info" href="{{ route('provider.marketers.edit', $marketer->id) }}">تعديل</a>
            <!-- <a class="btn btn-sm btn-danger" href="{{ route('provider.marketers.destroy', $marketer->id) }}">حذف </a> -->
            </form>
            <a class="btn btn-sm btn-success" href="{{ route('provider.marketers.chargeForm', $marketer->id) }}"> شحن المسوق</a>
            </form>
          </td>
