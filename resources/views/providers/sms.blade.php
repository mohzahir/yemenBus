...
@include('flash-message')
 ...
 <input type="hidden" class="form-control" id="provider_id" name="user_id"  value="{{Auth::guard('provider')->user()->id}}" >
        ...
        <div class="form-group mt-2">
            ...
            <input type="text" class="form-control" id="passenger_phone_yem" name="passenger_phone_yem" placeholder="مثال +9671231313131"  @if($reservation) value="{{$reservation->passenger->y_phone}}" @endif>
        </div>
        <!-- @if($reservation)
