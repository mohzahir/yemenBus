...
<div class="main_container col-md-12 col-md-8 col-sm-12 col-xs- " style="margin-left:200px;">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">  طلبات حجز الركاب </li>
  </ol>
</nav>
        <h1 style ="text-align:center">طلبات حجز الركاب</h1>
...
<td>{{App\Trip::getCityName($reservation->from_city) }}</td>
                    ...
                    <a class="btn btn-sm btn-warning" href="{{ route('provider.reservations.postpone_car',$reservation->id) }}">تأجيل الحجز</a>
                    <a class="btn btn-sm btn-danger" href="{{ route('provider.reservations.cancel_car',$reservation->id) }}">الغاء الحجز</a>
                    <!-- <a class="btn btn-sm btn-success" href="{{ route('provider.reservations.transfer_car',$reservation->id) }}">نقل الى</a> -->
                    </td>
                    ...
                    <a class="btn btn-sm btn-success" @if($reservation->passenger_phone) href="https://api.whatsapp.com/send?phone={{ $reservation->passenger_phone}}" @else href="https://api.whatsapp.com/send?phone={{ $reservation->passenger_phone_yem}}" @endif style="width:100px">واتس اب </a>
