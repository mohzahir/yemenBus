...
<div class="main_container col-md-12 col-md-8 col-sm-12 col-xs- "  style="margin-left:70px;">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page"> طلب الغاء الحجز </li>
  </ol>
</nav>
<h1 style="text-align:center">طلب الغاء الحجز</h1>
...
$(document).on('submit','#myForm', function (e) {
    ...
    $.ajax({
        type: "post",
        url: "{{route('provider.reservations.storeCancel')}}",
        data:{           
            "_token": "{{ csrf_token() }}",
             "id": $("#id").val(),
