    ...
    <div class="main_container col-md-12 col-md-8 col-sm-12 col-xs- " style="margin-left:70px;">
        <nav aria-label="breadcrumb" style="margin-top:-50px;">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"> تعديل مدينة</li>
            </ol>
        </nav>
        <h1 style="text-align:center">تعديل مدينة </h1>
        ...
        <form method="POST" action="{{ route('admin.city.update',[$city->id]) }}"
            ...
            <div class="form-group">
                ...
                <select name="country" class="form-control">
                    ...
                    <option value="1" {{ old('country',$city->country) == 1 ? "selected" : "" }}>السعودية </option>
                    <option value="2" {{ old('country',$city->country) == 2 ? "selected" : "" }}>اليمن </option>
