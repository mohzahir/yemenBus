                    ...
                    <ul>
                        ...
                        <li><span class="glyphicon glyphicon-user"></span><a
                            ...
                            <ul class="drop_main_menu">
                                ...
                                <li><a href="{{route('dashboard.providers.pfar')}}">طلبات صلاحيه مالية للمسوقين </a>
                                </li>
                        ...
                        <li><span class="glyphicon glyphicon-edit"></span>
                            <a href="{{route('admin.ticket.index')}}"> المدفوعات  </a>
                        </li>
                        <li><span class="glyphicon glyphicon-edit"></span>
                            <a href="{{route('dashboard.provider.trip.create')}}">اضافة رحلات</a></li>
                        <li><span class="glyphicon glyphicon-edit">
                            </span><a href="{{route('dashboard.providers.trips')}}">الرحلات</a></li>

                        <li><span class="glyphicon glyphicon-edit"></span>
                            <a href="{{route('admin.city.index')}}"> عرض المدن </a>
                        </li>
                            <li><span class="glyphicon glyphicon-edit"></span>
                                <a href="{{route('admin.city.create')}}"> اضافة مدن </a>
                            </li>

                        <li><span class="glyphicon glyphicon-edit"></span>
                            <a href="{{route('dashboard.admin.setting')}}">أعدادت الحساب </a></li>
