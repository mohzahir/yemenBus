...
@include('flash-message')
    ...
    <form method="post" action="{{route('admin.lab.smsSend',$lab->id)}}" class="pb-4 @if ($errors->any()) was-validated @endif" >
        @csrf
...
<input  name="user_id" value="{{Auth::guard('admin')->user()->id}}" type="hidden">
        ...
        <div class="form-group mt-2">
            ...
            <input type="text" class="form-control" id="phone" name="phone" placeholder="مثال 0501234567"   @if($lab->phone) value="{{$lab->phone}}" @endif >
        </div>
