        ...
        <tbody>
            ...
            {{-- @if($provider_name) --}}
               ...
               @endswitch
                    ...
                    {{-- <td>@if( $reservation->image)<a href="{{ route('admin.image.download', $reservation->id) }}">صورة الطلب</a>@endif</td> --}}
                    ...
                    <a class="btn btn-sm btn-danger" href="{{ route('admin.reservations.cancel',$reservation->id) }}">الغاء الحجز</a>
