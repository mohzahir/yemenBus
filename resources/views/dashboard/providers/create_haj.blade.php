...
<div class="main_container col-md-12 col-md-8 col-sm-12 col-xs- "  style="margin-left:70px;">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page"> اضافة مزود حج وعمرة</li>
  </ol>
</nav>
   <h1 style ="text-align:center">اضافة مزود حج وعمرة </h1>
@include('flash-message')

    <form method="POST" action="{{ route('dashboard.providers.store_haj') }}"  class="pb-4 @if ($errors->any()) was-validated @endif" enctype="multipart/form-data">
        @csrf
        <div class="form-group">
            <label for="name">اسم المزود او الشركة   </label>
