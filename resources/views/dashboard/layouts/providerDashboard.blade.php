...
<div class="container-fluid">
 ...
 <li><span class="glyphicon glyphicon-envelope"></span><a href="{{route('provider.sms')}}">ارسال رسالة للعميل</a></li>
                   ...
                   <li><span class="glyphicon glyphicon-envelope"></span><a href="{{route('logout.provider')}}" onclick="event.preventDefault();document.getElementById('logout-form').submit();"> تسحجيل الخروج </a></li>
