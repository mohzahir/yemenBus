...
<div class="container-fluid">
  ...
  <li><span class="glyphicon glyphicon-edit"></span><a href="{{route('dashboard.reservations.confirm')}}">تاكيد الحجوزات</a></li>
                    ...
                    <li><span class="glyphicon glyphicon-envelope"></span>
                        <a href="{{route('dashboard.marketer.sms')}}">ارسال رسالة للعميل</a></li>
...
<li><span class="glyphicon glyphicon-envelope"></span><a href="{{route('logout.marketer')}}" onclick="event.preventDefault();document.getElementById('logout-form').submit();"> تسحجيل الخروج </a></li>
