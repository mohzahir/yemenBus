...
<div class="container-fluid">
    ...
    <div class="row container_section">
        ...
        <div class="main_sidebar bring_right" style="width:250px;">
            <div class="main_sidebar_wrapper">
                ...
                <li><span class="glyphicon glyphicon-home"></span><a href="{{route('dashboard.admin.index')}}">صفحه رئيسية</a></li>
                    ...
                    <li><span class="glyphicon glyphicon-user"></span><a href="{{route('admin.lab.index')}}">المختبرات </a>
                        <ul class="drop_main_menu">
                    ...
                    <li><span class="glyphicon glyphicon-user"></span><a href="{{route('dashboard.providers.index')}}">المزودون </a>
                        ...
                        <li><a href="{{route('dashboard.providers.trips')}}">الرحلات</a></li>
                        </ul>
                    </li>
                    
                    <li><span class="glyphicon glyphicon-edit"></span><a href="{{route('dashboard.admin.setting')}}">أعدادت الحساب </a></li>
                    <li><span class="glyphicon glyphicon-edit"></span><a href="{{route('logout.admin')}}">تسجيل الخروج </a></li>
        ...
        <div class="main_content_container" style="margin-right:-150px;"> 
