...
<div class="form-group mt-2">
 ...
 <div class="form-group mt-2">
            <label for="done_img">(اختياري) ارفاق صورة الفحص</label>
            <input type="file" class="form-control" name="done_img" id="done_img"   >

            </select>        </div>
<div class="form-group mt-2">
                <label for="note_check" style="text-align:right"> ملاحظات (اختياري)  </label>
            <input type="text" class="form-control" name="note_check" id="note_check" >
        ...
        <button class="btn btn-success btn-lg" name="action" value=" send" type="submit">حفظ وارسال نتيجه</button>
