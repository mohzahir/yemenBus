...
<div class="main_container col-md-12 col-md-8 col-sm-12 col-xs- "  style="margin-left:70px;margin-top:30px;">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">  مشاركة  الفحص</li>
  </ol>
</nav>
<h1 style="text-align:center">مشاركة الفحص   </h1>
...
<span style="width:100%;color:black;font-size:14px;">  رقم  الجوال بلارقام التالية :1234567890  </span>
    ...
    <form method="post" action="{{route('dashboard.lab.shareSend',$pcr->id)}}" class="pb-4 @if ($errors->any()) was-validated @endif" style="margin-bottom:40px;">
        @csrf
