...
<main>
    ...
    <div class="slider-area ">
        ...
        <div class="slider-active">
            ...
            data-background="{{asset('passenger-assets/img/hero/bus1-old.jpg')}}">
                <div class="container bus-slider">
                    <div class="row">
                        <div class="col-xl-5">
                            <!-- form -->
                            <form action="{{route('passengers.searchTrips_msg')}}" method="get" class="search-box">
                                @csrf
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-9 caption-div">
                            <div class="hero__caption">
                                <h1>احجز  مع <span> مرسول اليمن</span> </h1>
...
<div class="whole-wrap">
  <div class="container box_1170">
    ...
    <h1 style="text-align: center">نقل البضائع مع مرسول اليمن</h1>
