            ...
            data-background="{{asset('passenger-assets/img/hero/haj.jpg')}}">
                <div class="container bus-slider">
                    <div class="row">
                        <div class="col-xl-5">
                            <!-- form -->
                            <form action="{{route('passengers.searchTrips_haj')}}" method="get" class="search-box">
                                @csrf
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-9 caption-div">
                            <div class="hero__caption">
                                <h1>احجز  <span> رحلة حج وعمرة</span> </h1>
                                <p>احجز  بأقل من دقيقتين</p>
                            </div>
                        </div>
                    </div>
                    <!-- Search Box -->
...
<div class="whole-wrap">
  <div class="container box_1170">
    ...
    <h1 style="text-align: center">رحلات الحج والعمرة</h1>
        ...
        <div>
          <table class="table mt-3 trip-dep">
            ...
            <tr>
              ...
              <td><a href="{{ route('passengers.reserveTrips_haj',[$tripYemen->id, 1])}}" class="btn btn-info trip-btn">احجز</a></td>
              <td>
            حج وعمرة
