...
<div class="main_container col-md-12 col-md-8 col-sm-12 col-xs- " >
    ...
    <div class="d-flex justify-content-between" style="dispaly:inline;margin-bottom:50px;">
        <nav aria-label="breadcrumb" style="margin-top:-50px;">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item " aria-current="page"> <a href="{{route('marketer.haj.reservations.index')}}">حجوزات الحج والعمرة</a></li>
                <li class="breadcrumb-item active" aria-current="page"> حجز رقم {{ ($reservation->id) }}</li>
            </ol>
        </nav>
        <h1 style="text-align:center">معلومات الحاج\المعتمر برقم الحجز ({{ $reservation->id }})</h1>
    ...
    <div class="row">
        ...
        <form action="{{ route('marketer.haj.reservations.storePassengerInfo', ['id' => $reservation->id]) }}" method="post">
            @csrf
            <div class="col-md-6">
                <div class="form-group">
                    <label for="">اسم الحاج\المعتمر</label>
                    <p class="border inline">
                        {{ $reservation->passenger->name_passenger }}
                    </p>
                </div>
            </div>
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="">رقم الحاج\المعتمر</label>
                    <p class="border inline">
                        {{ $reservation->passenger->phone ?? $reservation->passenger->y_phone }}
                    </p>
                </div>
            </div>
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <p class="border inline">
                        {{ $reservation->passenger->email ?? 'لايوجد' }}
                    </p>
                </div>
            </div>
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <p class="border inline">
                        {{ $reservation->passenger->gender  ?? 'لايوجد' }}
                    </p>
                </div>
            </div>
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <p class="border inline">
                        {{ $reservation->passenger->age  ?? 'لايوجد' }}
                    </p>
                </div>
            </div>
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <p class="border inline">
                        {{ $reservation->passenger->dateofbirth  ?? 'لايوجد' }}
                    </p>
                </div>
            </div>
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <p class="border inline">
                        {{ $reservation->passenger->p_id  ?? 'لايوجد' }}
                    </p>
                </div>
            </div>
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="">صورة الجواز</label>
                    <img src="{{ asset($reservation->passenger_passport_img) }}" alt="">
                </div>
            </div>
            <div class="col-md-6">

                <div class="form-group">
                    <label for="">رقم تزكرة الطيران</label>
                    <input type="text" class="form-control" name="haj_passenger_external_ticket_number" value="{{ $reservation->haj_passenger_external_ticket_number }}">
                </div>
            </div>
            <div class="col-md-6">

                <div class="form-group">
                    <label for="">معلومات الفندق والاقامة</label>
                    <textarea type="text" class="form-control" name="haj_passenger_hotel_details">
                    {{ $reservation->haj_passenger_hotel_details }}
                    </textarea>
                </div>
            </div>
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="">الحالة المرضية للمسافر</label>
                    <textarea type="text" class="form-control" name="haj_passenger_sickness_status">
                    {{ $reservation->haj_passenger_sickness_status }}
                    </textarea>
                </div>
            </div>
            <div class="col-md-12 mt-3">
                <button class="btn btn-success">حفظ المعلومات</button>
                <a href="{{ route('marketer.reservations.confirmAll') }}" class="btn btn-danger">رجوع</a>
            </div>
        </form>
