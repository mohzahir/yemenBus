...
<div class="main_container col-md-12 col-md-8 col-sm-12 col-xs- " style="margin-left:70px;">
    ...
    <form action="{{ route('marketer.reservations.update',['id' => $reservation->id]) }}" method="post" class="pb-4 @if ($errors->any()) was-validated @endif" style="margin-bottom:40px;">
        @csrf
        ...
        <a class="btn btn-danger btn-close btn-lg" href="{{ route('marketer.reservations.confirmAll') }}">رجوع</a>
...
<script type="text/javascript">
    $(document).on('submit', '#myForm', function(e) {
        ...
        swal({
            ...
            $.ajax({
                type: 'post',
                url: "{{route('marketer.reservations.update',$reservation->id)}}",
                /*data: {           
                    "_token": "{{ csrf_token() }}",
                    "id": $("#id").val(),
