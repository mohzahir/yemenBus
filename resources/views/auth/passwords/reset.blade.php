...
@include('flash-message')
                ...
                <div class="form-group row">
                            <label for="password" class="col-md-4 col-form-label text-md-right">كلمه المرور الجديدة</label>

                            <div class="col-md-6">
                                <input id="password" type="password" class="border w-full p-2 border-gray-400 focus:border-gray-500 round @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" type="password" class="border w-full p-2 border-gray-400 focus:border-gray-500 round @error('password-confirm') is-invalid @enderror" name="password_confirmation" required autocomplete="new-password">
                            </div>
                        </div>
